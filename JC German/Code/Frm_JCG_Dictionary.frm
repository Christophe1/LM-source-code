...
Begin VB.Form Frm_JCG_Dictionary 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Dictionary Box"
   ClientHeight    =   3270
   ClientLeft      =   150
   ClientTop       =   720
   ClientWidth     =   2865
   Icon            =   "Frm_JCG_Dictionary.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3270
   ...
   Begin WebsterProLib.WebsterPro WebsterPro_Print 
      Height          =   1575
      Left            =   240
      TabIndex        =   1
      Top             =   0
   ...
   Begin VB.TextBox Text1 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   2
      Text            =   "Frm_JCG_Dictionary.frx":08CA
      Top             =   1680
      Visible         =   0   'False
      Width           =   1215
   End
   Begin WebsterProLib.WebsterPro WebsterPro_Dictionary 
      Height          =   3255
      Left            =   0
      TabIndex        =   0
      Top             =   0
      ...
      ScrollbarStyleVertical=   0
      ScrollbarStyleHorizontal=   0
      MenuControl     =   0
   End
   Begin VB.Menu Print 
      Caption         =   "Print all Dictionary"
   End
End
Attribute VB_Name = "Frm_JCG_Dictionary"
...
Me.Show , Frm_JCG_Learn_and_Revise

'open the dictionary_print file in the hidden text1 control
Call print_dictionary

'translate the encrypted text in text1, the dictionary to be printed, into the WebsterPro_Print control
WebsterPro_Print.Navigate "file:///" & App.Path & "\Aural\Transcripts\", NavCreateFromText, 0, "", Text1, ""
...
'this prints the encrypted dictionary_print file.
On Error GoTo ErrHandler
Printer.Print Frm_JCG_Dictionary.WebsterPro_Print.DoPrint(True, FromPage, ToPage)
