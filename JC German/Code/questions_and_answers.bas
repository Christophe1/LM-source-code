...
Open App.Path & "\Aural\Questions & Answers\" & Frm_JCG_Test_Yourself.txtauralyear & Frm_JCG_Test_Yourself.Text_Question.Text & ".aye" For Input As iFile
DoEvents
...
DoEvents
Frm_JCG_Test_Yourself.Text_JCF_QuestionBox.Text = stext
Frm_JCG_Test_Yourself.Text_JCF_QuestionBox2.Text = stext
...
Frm_JCG_Test_Yourself.Text_JCF_QuestionBox.Text = DecryptText(Mid(stext, 13))
Frm_JCG_Test_Yourself.Text_JCF_QuestionBox2.Text = DecryptText(Mid(stext, 13))
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Questions & Answers\" & Frm_JCG_Test_Yourself.txtauralyear & Frm_JCG_Test_Yourself.Text_Answer.Text & ".aye" For Input As iFile
...
On Error Resume Next
Frm_JCG_Test_Yourself.Text_JCF_AnswerBox.Text = DecryptText(Mid(stext, 13))
...
DoEvents
'Frm_JCG_Learn_and_Revise.Text1.Text = stext
...
Frm_JCG_Learn_and_Revise.Text1.Text = DecryptText(Mid(stext, 13))
...
'    Public TmpFRD As Date
    ...
    TmpCRD = Date
    TmpLRD = GetSetting("myapp", "JCGerman", "LRD", "1/1/2000")
    TmpFRD = GetSetting("myapp", "JCGerman", "FRD", "1/1/2000")
    ...
    If TmpLRD = "1/1/2000" Then
        SaveSetting "myapp", "JCGerman", "LRD", TmpCRD
        SaveSetting "myapp", "JCGerman", "FRD", TmpCRD
'        SaveSetting "myapp", "JCGerman", "timesrun", no_of_times + 5
    End If
...
'    timesrun = GetSetting("myapp", "JCGerman", "timesrun", no_of_times + 5)
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Transcripts\dictionary" & Frm_JCG_Learn_and_Revise.Text2.Text & "_print.aye" For Input As iFile
DoEvents
'& Year & "_print.aye"
stext = Input(LOF(iFile), iFile)
...
DoEvents
Frm_JCG_Dictionary.Text1.Text = stext
...
Frm_JCG_Dictionary.Text1.Text = DecryptText(Mid(stext, 13))
