...
Frm_JCS_Test_Yourself.CommonDialog1.CancelError = True
Frm_JCS_Test_Yourself.CommonDialog1.Flags = cdlOFNFileMustExist
On Error GoTo ErrHandler
Frm_JCS_Test_Yourself.CommonDialog1.Flags = cdlOFNFileMustExist
' Specify default filter
'Set the properties of the text control
Frm_JCS_Test_Yourself.CommonDialog1.Filter = "Text Files(*.txt)|*.txt*|All files(*.*)|*.*"
'.Filter = "AY Encrypted|*.aye"
Frm_JCS_Test_Yourself.CommonDialog1.DefaultExt = "txt"
Frm_JCS_Test_Yourself.CommonDialog1.FilterIndex = 1
Frm_JCS_Test_Yourself.CommonDialog1.ShowOpen

Open Frm_JCS_Test_Yourself.CommonDialog1.FileName For Input As #1
Frm_JCS_Test_Yourself.Text_jcs_QuestionBox.Text = Input(LOF(1), 1)
Close #1
...
With Frm_JCS_Test_Yourself.CommonDialog1
.CancelError = True
...
Print #iFile, EncryptText(Frm_JCS_Test_Yourself.Text_jcs_QuestionBox);
Close iFile
End With
MsgBox "Saved"
Cancelled:
...
Open Frm_JCS_Test_Yourself.CommonDialog1.FileName For Input As #1
Frm_JCS_Test_Yourself.Text_jcs_AnswerBox.Text = Input(LOF(1), 1)
Close #1
...
iFile = FreeFile
Open .FileName For Output As iFile
Print #iFile, EncryptText(Frm_JCS_Test_Yourself.Text_jcs_AnswerBox);
Close iFile
End With
MsgBox "Saved"
Cancelled:
