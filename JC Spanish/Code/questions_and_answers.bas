...
Open App.Path & "\Aural\Questions & Answers\" & Frm_JCS_Test_Yourself.txtauralyear & Frm_JCS_Test_Yourself.Text_Question.Text & ".aye" For Input As iFile
DoEvents
...
DoEvents
Frm_JCS_Test_Yourself.Text_jcs_QuestionBox.Text = stext
Frm_JCS_Test_Yourself.Text_jcs_QuestionBox2.Text = stext
...
Frm_JCS_Test_Yourself.Text_jcs_QuestionBox.Text = DecryptText(Mid(stext, 13))
Frm_JCS_Test_Yourself.Text_jcs_QuestionBox2.Text = DecryptText(Mid(stext, 13))
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Questions & Answers\" & Frm_JCS_Test_Yourself.txtauralyear & Frm_JCS_Test_Yourself.Text_Answer.Text & ".aye" For Input As iFile
...
On Error Resume Next
Frm_JCS_Test_Yourself.Text_jcs_AnswerBox.Text = DecryptText(Mid(stext, 13))
...
DoEvents
'Frm_JCS_Learn_and_Revise.Text1.Text = stext
...
Frm_JCS_Learn_and_Revise.Text1.Text = DecryptText(Mid(stext, 13))
...
'    Public TmpFRD As Date
    ...
    TmpCRD = Date
    TmpLRD = GetSetting("myapp", "JCSerman", "LRD", "1/1/2000")
    TmpFRD = GetSetting("myapp", "JCSerman", "FRD", "1/1/2000")
    ...
    If TmpLRD = "1/1/2000" Then
        SaveSetting "myapp", "JCSerman", "LRD", TmpCRD
        SaveSetting "myapp", "JCSerman", "FRD", TmpCRD
'        SaveSetting "myapp", "JCSerman", "timesrun", no_of_times + 5
    End If
...
'    timesrun = GetSetting("myapp", "JCSerman", "timesrun", no_of_times + 5)
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Transcripts\dictionary" & Frm_JCS_Learn_and_Revise.Text2.Text & "_print.aye" For Input As iFile
DoEvents
'& Year & "_print.aye"
stext = Input(LOF(iFile), iFile)
...
DoEvents
Frm_JCS_Dictionary.Text1.Text = stext
...
Frm_JCS_Dictionary.Text1.Text = DecryptText(Mid(stext, 13))
