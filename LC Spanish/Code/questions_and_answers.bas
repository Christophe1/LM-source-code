...
Open App.Path & "\Aural\Questions & Answers\" & Frm_lcs_Test_Yourself.txtauralyear & Frm_lcs_Test_Yourself.Text_Question.Text & ".aye" For Input As iFile
DoEvents
...
DoEvents
Frm_lcs_Test_Yourself.Text_lcs_QuestionBox.Text = stext
Frm_lcs_Test_Yourself.Text_lcs_QuestionBox2.Text = stext
...
Frm_lcs_Test_Yourself.Text_lcs_QuestionBox.Text = DecryptText(Mid(stext, 13))
Frm_lcs_Test_Yourself.Text_lcs_QuestionBox2.Text = DecryptText(Mid(stext, 13))
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Questions & Answers\" & Frm_lcs_Test_Yourself.txtauralyear & Frm_lcs_Test_Yourself.Text_Answer.Text & ".aye" For Input As iFile
...
On Error Resume Next
Frm_lcs_Test_Yourself.Text_lcs_AnswerBox.Text = DecryptText(Mid(stext, 13))
...
DoEvents
'Frm_lcs_Learn_and_Revise.Text1.Text = stext
...
Frm_lcs_Learn_and_Revise.Text1.Text = DecryptText(Mid(stext, 13))
...
'    Public TmpFRD As Date
    ...
    TmpCRD = Date
    TmpLRD = GetSetting("myapp", "lcserman", "LRD", "1/1/2000")
    TmpFRD = GetSetting("myapp", "lcserman", "FRD", "1/1/2000")
    ...
    If TmpLRD = "1/1/2000" Then
        SaveSetting "myapp", "lcserman", "LRD", TmpCRD
        SaveSetting "myapp", "lcserman", "FRD", TmpCRD
'        SaveSetting "myapp", "lcserman", "timesrun", no_of_times + 5
    End If
...
'    timesrun = GetSetting("myapp", "lcserman", "timesrun", no_of_times + 5)
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Transcripts\dictionary" & Frm_lcs_Learn_and_Revise.Text2.Text & "_print.aye" For Input As iFile
DoEvents
'& Year & "_print.aye"
stext = Input(LOF(iFile), iFile)
...
DoEvents
Frm_LCS_Dictionary.Text1.Text = stext
...
Frm_LCS_Dictionary.Text1.Text = DecryptText(Mid(stext, 13))
