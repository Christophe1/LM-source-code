...
Frm_LCG_Test_Yourself.CommonDialog1.CancelError = True
Frm_LCG_Test_Yourself.CommonDialog1.Flags = cdlOFNFileMustExist
On Error GoTo ErrHandler
Frm_LCG_Test_Yourself.CommonDialog1.Flags = cdlOFNFileMustExist
' Specify default filter
'Set the properties of the text control
Frm_LCG_Test_Yourself.CommonDialog1.Filter = "Text Files(*.txt)|*.txt*|All files(*.*)|*.*"
'.Filter = "AY Encrypted|*.aye"
Frm_LCG_Test_Yourself.CommonDialog1.DefaultExt = "txt"
Frm_LCG_Test_Yourself.CommonDialog1.FilterIndex = 1
Frm_LCG_Test_Yourself.CommonDialog1.ShowOpen

Open Frm_LCG_Test_Yourself.CommonDialog1.FileName For Input As #1
Frm_LCG_Test_Yourself.Text_JCF_QuestionBox.Text = Input(LOF(1), 1)
Close #1
...
With Frm_LCG_Test_Yourself.CommonDialog1
.CancelError = True
...
Print #iFile, EncryptText(Frm_LCG_Test_Yourself.Text_JCF_QuestionBox);
Close iFile
End With
MsgBox "Saved"
Cancelled:
...
Open Frm_LCG_Test_Yourself.CommonDialog1.FileName For Input As #1
Frm_LCG_Test_Yourself.Text_JCF_AnswerBox.Text = Input(LOF(1), 1)
Close #1
...
iFile = FreeFile
Open .FileName For Output As iFile
Print #iFile, EncryptText(Frm_LCG_Test_Yourself.Text_JCF_AnswerBox);
Close iFile
End With
MsgBox "Saved"
Cancelled:
