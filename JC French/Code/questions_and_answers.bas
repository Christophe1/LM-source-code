...
Open App.Path & "\Aural\Questions & Answers\" & Frm_JCF_Test_Yourself.txtauralyear & Frm_JCF_Test_Yourself.Text_Question.Text & ".aye" For Input As iFile
DoEvents
...
DoEvents
Frm_JCF_Test_Yourself.Text_JCF_QuestionBox.Text = stext
Frm_JCF_Test_Yourself.Text_JCF_QuestionBox2.Text = stext
...
Frm_JCF_Test_Yourself.Text_JCF_QuestionBox.Text = DecryptText(Mid(stext, 13))
Frm_JCF_Test_Yourself.Text_JCF_QuestionBox2.Text = DecryptText(Mid(stext, 13))
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Questions & Answers\" & Frm_JCF_Test_Yourself.txtauralyear & Frm_JCF_Test_Yourself.Text_Answer.Text & ".aye" For Input As iFile
...
On Error Resume Next
Frm_JCF_Test_Yourself.Text_JCF_AnswerBox.Text = DecryptText(Mid(stext, 13))
...
DoEvents
'Frm_JCF_Learn_and_Revise.Text1.Text = stext
...
Frm_JCF_Learn_and_Revise.Text1.Text = DecryptText(Mid(stext, 13))
...
'
'Select Case Frm_jcf_Test_Yourself.Show_Answers_Button.Caption
'Case "Show Answers"
'    Frm_jcf_Test_Yourself.Show_Answers_Button.Caption = "Hide Answers"
'    'Form1.Text1.Width = 3455
'    'Form1.Text3.Visible = False
'    Frm_jcf_Test_Yourself.Text_jcf_QuestionBox2.Visible = False
''    Frm_jcf_Test_Yourself.Text_jcf_QuestionBox2.Move 3360, 2160  '13360, 13200
'
'Case "Hide Answers"
'    Frm_jcf_Test_Yourself.Show_Answers_Button.Caption = "Show Answers"
'   ' Form1.Text1.Width = 6655
'   ' Form1.Text3.Visible = True
'    Frm_jcf_Test_Yourself.Text_jcf_QuestionBox2.Visible = True
'
'End Select
'End Function
...
'    Public TmpFRD As Date
    ...
    TmpCRD = Date
    TmpLRD = GetSetting("myapp", "JCFrench", "LRD", "1/1/2000")
    TmpFRD = GetSetting("myapp", "JCFrench", "FRD", "1/1/2000")
    ...
    If TmpLRD = "1/1/2000" Then
        SaveSetting "myapp", "JCFrench", "LRD", TmpCRD
        SaveSetting "myapp", "JCFrench", "FRD", TmpCRD
'        SaveSetting "myapp", "JCFrench", "timesrun", no_of_times + 5
    End If
...
'    timesrun = GetSetting("myapp", "JCFrench", "timesrun", no_of_times + 5)
...
'Public Function open_dictionary()
...
'iFile = FreeFile
'On Error Resume Next
'Open App.Path & "\Aural\Transcripts\dictionary2003.aye" For Input As iFile
'DoEvents
''& Year & "_print.aye"
'stext = Input(LOF(iFile), iFile)
'
...
'
'DoEvents
'Frm_JCF_Dictionary.Text1.Text = stext
'
'
'errH:
'If Err.Number > 0 Then
...
'End If
'
'Frm_JCF_Dictionary.Text1.Text = DecryptText(Mid(stext, 13))
'
'
'End Function
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Transcripts\dictionary" & Frm_JCF_Learn_and_Revise.Text2.Text & "_print.aye" For Input As iFile
DoEvents
'& Year & "_print.aye"
stext = Input(LOF(iFile), iFile)
