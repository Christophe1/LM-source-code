...
Open App.Path & "\Aural\Questions & Answers\" & Frm_JCI_Test_Yourself.txtauralyear & Frm_JCI_Test_Yourself.Text_Question.Text & ".aye" For Input As iFile
DoEvents
...
DoEvents
Frm_JCI_Test_Yourself.Text_jci_QuestionBox.Text = stext
Frm_JCI_Test_Yourself.Text_jci_QuestionBox2.Text = stext
...
Frm_JCI_Test_Yourself.Text_jci_QuestionBox.Text = DecryptText(Mid(stext, 13))
Frm_JCI_Test_Yourself.Text_jci_QuestionBox2.Text = DecryptText(Mid(stext, 13))
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Questions & Answers\" & Frm_JCI_Test_Yourself.txtauralyear & Frm_JCI_Test_Yourself.Text_Answer.Text & ".aye" For Input As iFile
...
On Error Resume Next
Frm_JCI_Test_Yourself.Text_jci_AnswerBox.Text = DecryptText(Mid(stext, 13))
...
DoEvents
Frm_JCI_Learn_and_Revise.Text1.Text = stext
...
Frm_JCI_Learn_and_Revise.Text1.Text = DecryptText(Mid(stext, 13))
...
'
'Select Case Frm_JCI_Test_Yourself.Show_Answers_Button.Caption
'Case "Show Answers"
'    Frm_JCI_Test_Yourself.Show_Answers_Button.Caption = "Hide Answers"
'    'Form1.Text1.Width = 3455
'    'Form1.Text3.Visible = False
'    Frm_JCI_Test_Yourself.Text_jci_QuestionBox2.Visible = False
''    Frm_JCI_Test_Yourself.Text_jci_QuestionBox2.Move 3360, 2160  '13360, 13200
'
'Case "Hide Answers"
'    Frm_JCI_Test_Yourself.Show_Answers_Button.Caption = "Show Answers"
'   ' Form1.Text1.Width = 6655
'   ' Form1.Text3.Visible = True
'    Frm_JCI_Test_Yourself.Text_jci_QuestionBox2.Visible = True
'
'End Select
'End Function
...
'    Public TmpFRD As Date
    ...
    TmpCRD = Date
    TmpLRD = GetSetting("myapp", "JCIrish", "LRD", "1/1/2000")
    TmpFRD = GetSetting("myapp", "JCIrish", "FRD", "1/1/2000")
    ...
    If TmpLRD = "1/1/2000" Then
        SaveSetting "myapp", "JCIrish", "LRD", TmpCRD
        SaveSetting "myapp", "JCIrish", "FRD", TmpCRD
'        SaveSetting "myapp", "JCIrish", "timesrun", no_of_times + 5
    End If
...
'    timesrun = GetSetting("myapp", "JCIrish", "timesrun", no_of_times + 5)
...
iFile = FreeFile
On Error Resume Next
Open App.Path & "\Aural\Transcripts\dictionary" & Frm_JCI_Learn_and_Revise.Text2.Text & "_print.aye" For Input As iFile
DoEvents
'& Year & "_print.aye"
stext = Input(LOF(iFile), iFile)
...
DoEvents
Frm_JCI_Dictionary.Text1.Text = stext
...
Frm_JCI_Dictionary.Text1.Text = DecryptText(Mid(stext, 13))
